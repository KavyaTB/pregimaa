...
urlpatterns = [
    ...
    path('event_m/', event_m, name='event_m'),
    ...
    path('view_exercise/', view_exercise, name='view_exercise'),
    path('view_meditation/', view_meditation, name='view_meditation'),
    path('vaccine_upload/', vaccine_upload, name='vaccine_upload'),
